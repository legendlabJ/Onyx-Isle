...
/* ============================================================
   CAROUSEL — auto-advancing slideshow with crossfade,
   pause on hover, click-to-jump navigation dots, and keyboard
   accessibility. Zero dependencies, vanilla JS.
   ============================================================ */
(function () {
  'use strict';
  ...
  function initCarousel(root) {
    ...
    // Pause when tab is not visible (saves CPU and battery)
